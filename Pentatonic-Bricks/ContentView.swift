...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            /*
            HStack {
                ForEach(pentatonicScales["C#"]!, id: \.self) { note in
                    Text(note)
                        .font(.title)
            ...
            HStack {
                ForEach(pentatonicScales["D"]!, id: \.self) { note in
                    Text(note)
                        .font(.title)
                        .frame(width: 60, height: 60)
                        .padding(1)
            ...
            HStack {
                ForEach(pentatonicScales["E"]!, id: \.self) { note in
                    Text(note)
                        .font(.title)
                        .frame(width: 60, height: 60)
                        .padding(1)
            ...
            HStack {
                ForEach(pentatonicScales["F"]!, id: \.self) { note in
                    Text(note)
                        .font(.title)
                        .frame(width: 60, height: 60)
                        .padding(1)
            ...
            HStack {
                ForEach(pentatonicScales["G"]!, id: \.self) { note in
                    Text(note)
                        .font(.title)
                        .frame(width: 60, height: 60)
                        .padding(1)
            ...
            HStack {
                ForEach(pentatonicScales["A"]!, id: \.self) { note in
                    Text(note)
                        .font(.title)
                        .frame(width: 60, height: 60)
                        .padding(1)
            ...
            HStack {
                ForEach(pentatonicScales["B"]!, id: \.self) { note in
                    Text(note)
                        .font(.title)
                        .frame(width: 60, height: 60)
                        .padding(1)
